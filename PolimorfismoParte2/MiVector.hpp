#pragma once
// =============================================================================
// MiVector.hpp — vector generico que implementa Contenedor<T>.
//   - Parametrico: la clase entera es un template sobre T.
//   - De subtipo:  hereda de Contenedor<T> y sobrescribe sus metodos virtuales.
//   - Ad-hoc:      sobrecarga de operator[], operator() y operator<<.
// =============================================================================
...
public:
    ...
    // ---- Ad-hoc: misma operacion, tres sintaxis ----
